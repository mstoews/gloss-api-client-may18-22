...
@Component({
  selector: 'app-dpm-scheduler-form',
  template: `
    <h1 mat-dialog-title>Dpm Scheduler Update</h1>
...
export class DpmSchedulerFormComponent {
  fg: FormGroup;
  oldduedate: Date;
  activeindicators = [
  ...
  constructor(
    public dialogRef: MatDialogRef<DpmSchedulerFormComponent>,
